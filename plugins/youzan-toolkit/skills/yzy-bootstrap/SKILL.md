---
name: yzy-bootstrap
description: 初始化或接管有赞云开放项目的本地开发环境。用于运行 YZY CLI、登录和选择应用、获取代码、安装 AI Skills、检查浏览器插件、初始化前端开放 2.0 工程、启动 H5/小程序/商家端 dev，或排查项目首次启动流程。
---
...
- 需要开放能力或 Slot 规则：使用 `youzan-frontend-open-dev` 并先查询 `yzy-knowledge-search`。
